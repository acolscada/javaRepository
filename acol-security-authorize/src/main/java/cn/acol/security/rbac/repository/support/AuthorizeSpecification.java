 ...
 * @param <C>
 */
public abstract class AuthorizeSpecification<T, C> extends AbstractEventConditionBuilder<T, C>
		implements Specification<T> {
	/**
	 * 
	 */
	private static final long serialVersionUID = -4434722592152592508L;

	/**
	 * @param condition
	 */
	public AuthorizeSpecification(C condition) {
		super(condition);
	}
