...
public class SmsCodeFilter extends OncePerRequestFilter implements InitializingBean{
	...
	public void afterPropertiesSet() throws ServletException {
		...
		String[] configUrls = StringUtils.splitByWholeSeparator(securityProperties.getValidateCodeProperties().getSmsCodeProperties().getUrl(), ",");
	...
	private void validate(HttpServletRequest request) throws ServletRequestBindingException {
		// TODO Auto-generated method stub
		ValidateCode codeInSession = (ValidateCode) request.getSession().getAttribute(ValidateCodeProcessor.SESSION_KEY_PREFIX+"SMS");
